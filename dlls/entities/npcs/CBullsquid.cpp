...
MONSTERSTATE CBullsquid::GetIdealState()
{
    ...
    case MONSTERSTATE_COMBAT:
        ...
        */
        {
            if (m_hEnemy != NULL && (iConditions & bits_COND_LIGHT_DAMAGE || iConditions & bits_COND_HEAVY_DAMAGE) && FClassnameIs(
                m_hEnemy->pev, "monster_headcrab"))
            {
